const groups = [
  {
    ...
    descriptions: {
      ...
      "Secondary Research": [
        "Know where and how to search for project-relevant information using reliable sources and tools. Digest and organise secondary research materials through detailed note-taking. Identify relevant subject matter experts who can provide valuable project insights.",
        "Organise secondary research by developing structured templated and using existing tools. Distill key insights with references connecting them to the project’s lines of inquiry. Create clear and engaging summaries of secondary research findings that align with the projects’ objective to communicate with project team, client and stakeholders.",
        "Frame problem statements within the research to identify gaps and opportunities. Engage subject matter experts for focused insights. Maintain an organised knowledge repository to keep insights clear, easy to access and ready to build on.",
      ],
      "Analysis & Synthesis": [
